...
export const humanizeText = async (text:string): Promise<string | null> => {
    ...
    try {
       ...
       // Guardar el texto humanizado en la base de datos
       //primero verificamos si hay respuesta de la ia y si el usuario esta logueado y tiene email
